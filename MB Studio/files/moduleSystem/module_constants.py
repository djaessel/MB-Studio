...
def test():
    ...
    try:
        ...
        print "Warning: You aren't using Native Module System! : %s" % (e)
    else:
        trade_goods_error_var = 1
    if num_trade_goods == itm_siege_supply:
        try:
            num_trade_goods = itm_siege_supply - itm_mead
        except Exception, e2:
            print "Error: You aren't using Vikings Module System! : %s" % (e2)
        else:    
            trade_goods_error_var = 2
...
trade_goods_begin = "itm_no_item"
trade_goods_end = "itm_no_item"
